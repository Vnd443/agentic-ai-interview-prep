# 21 — Agentic Coding Tools

> Claude Code, OpenCode, IBM BOB, Cline, Roo Code

**Tier:** 2 — Frameworks/Practice  |  **Interview frequency:** Medium

## Why this matters for your interviews
Proof you use agents daily, not just talk about them. Frame this as first-hand insight into agent design.

## Subtopics checklist
- [ ] How agentic coding tools work (loop + tools + verify)
- [ ] Context management on large repos
- [ ] Permissions & guardrails on actions
- [ ] Getting reliable results (spec, plan, verify, review)
- [ ] Comparing the tools you've used
- [ ] What using them taught you about building agents
...
- How to get reliable results / when not to trust them
- Compare tools and pick one
