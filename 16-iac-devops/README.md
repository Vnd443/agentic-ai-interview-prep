...
> Terraform, Ansible, GitLab CI/CD, Git

**Tier:** 3 — Backbone  |  **Interview frequency:** Medium

## Why this matters for your interviews
How your systems ship and stay reproducible. The Terraform-vs-Ansible split and an AI-aware CI pipeline are the key answers.

## Subtopics checklist
- [ ] Terraform: declarative provisioning + state
- [ ] Remote state + locking on a team
- [ ] Ansible: config management, idempotency
- [ ] Terraform provisions, Ansible configures
- [ ] GitLab CI/CD stages + eval gate for AI
- [ ] Rollback: canary / blue-green; secrets
...
- Terraform vs. Ansible — when each
- Terraform state management on a team
- Design a CI/CD pipeline for an AI service
