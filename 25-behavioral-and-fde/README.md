...
> STAR stories, Forward Deployed Engineer mindset, IBM war-stories

**Tier:** 4 — Interview Craft  |  **Interview frequency:** Very High (always)

## Why this matters for your interviews
Half of every loop. Prepare 3-5 quantified STAR stories that flex across prompts. For FDE, lead with ambiguity -> ship fast -> measured impact.

## Subtopics checklist
- [ ] STAR structure + quantifying results
- [ ] Ownership / ambiguity / failure stories
- [ ] Customer & stakeholder translation (FDE core)
- [ ] Speed vs. correctness judgment
...
- A project that was failing — what you did
- Translate a vague business ask into an AI solution
