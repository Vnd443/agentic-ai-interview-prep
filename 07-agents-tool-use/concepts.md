...
```
> Guards every loop needs: **max-iteration cap · budget · termination condition** (else it runs forever → see [[12-agent-orchestration]]). ReAct = interleave Reason + Act traces.
