...
2. Spawns **worker (sub-)agents**, each with its **own context window** (→ context isolation, see [[21-context-engineering]]).
...
- Memory across agents ties directly to [[21-context-engineering]] (what each agent knows, and what's isolated).
...
_Related: [[05-agents-tool-use]] · [[21-context-engineering]] · [[11-langchain-and-langgraph]] · [[06-mcp-and-custom-skills]] · [[18-llm-system-design]] · [[09-cost-optimization]]_
