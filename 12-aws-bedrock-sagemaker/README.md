# 12 — AWS Bedrock & SageMaker

> Managed foundation models, model hosting, deployment

**Tier:** 2 — Frameworks/Platform  |  **Interview frequency:** Medium

## Why this matters for your interviews
Your cloud-AI surface. Know the Bedrock-vs-SageMaker boundary cold and how to build RAG on AWS.

## Subtopics checklist
- [ ] Bedrock: managed FMs, pay-per-token
- [ ] Bedrock Knowledge Bases / Agents / Guardrails
- [ ] SageMaker: train / fine-tune / host
- [ ] Endpoint types: real-time / async / batch
- [ ] RAG on AWS (embeddings + vector store + FM)
- [ ] Autoscaling, cost, VPC/data residency
...
- Bedrock vs. SageMaker — when each
- RAG on AWS with Bedrock
- Deploy & scale a SageMaker endpoint
