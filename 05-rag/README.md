...
- [ ] Chunking strategy: size / overlap / structure-aware — and how to tune it
- [ ] Hybrid retrieval: vector + BM25 (+ graph); fusion
- [ ] Retrieval metrics: Precision@k, Recall@k, MRR, nDCG
- [ ] RAG Triad: context relevance · groundedness/faithfulness · answer relevance
- [ ] Graph RAG with a knowledge graph (Neo4j) — when relationships matter
- [ ] Ingestion with Docling; PII redaction & entity extraction
- [ ] Agentic RAG — the agent decides when/what to retrieve, and re-queries
- [ ] Why RAG exists — parametric vs non-parametric knowledge; when RAG beats fine-tuning
- [ ] Chunk enrichment — contextual retrieval: add title/summary/surrounding context per chunk
