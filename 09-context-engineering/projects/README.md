...
**Interview use:** the canonical context-engineering story. Ties to [[12-agent-orchestration]] loop control.
...
**Interview use:** links context engineering to [[15-cost-optimization]].
