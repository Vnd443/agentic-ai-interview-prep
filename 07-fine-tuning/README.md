...
> When vs. prompt engineering, LoRA, distillation, catastrophic forgetting

> 📌 **Seeded from AI_Engineer_Interview_Guide.pdf — Q05 (Fine-Tuning).** See `interview-qa.md`.

**Tier:** 1 — GenAI Core  |  **Interview frequency:** Medium-High

## Why this matters for your interviews
Tests pragmatic trade-off judgment — the most valued applied-AI skill. The right answer is usually 'prompt first, fine-tune only when...'.

## Subtopics checklist
- [ ] Prompt-engineering-first mindset
- [ ] When to fine-tune vs. not (the checklist)
- [ ] LoRA / PEFT / QLoRA
- [ ] Distillation (big model -> small)
- [ ] Catastrophic forgetting & mitigation
- [ ] Building a clean fine-tune dataset
...
- Fine-tune vs. prompt engineering (guide Q05)
- What is LoRA and why popular
