...
- RAG as the *Select* lever → [[04-rag]]
- Sub-agent isolation → [[22-agent-orchestration]]
- Prompt caching economics → [[09-cost-optimization]]
- Token/window fundamentals → [[01-llm-foundations]]
