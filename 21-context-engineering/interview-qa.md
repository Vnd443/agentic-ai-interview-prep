...
**Follow-ups:** What's usually the biggest token consumer? (raw tool results) · How do sub-agents help? (context isolation → [[22-agent-orchestration]])
...
**Follow-ups:** How is this different from a normal hallucination? (it *persists* and compounds) · Ties to guardrails → [[10-safety-and-guardrails]].
...
**Follow-ups:** What breaks the cache? (changing the prefix) · Quantify caching savings? (~90% on cached reads) → [[09-cost-optimization]]
...
_Related: [[04-rag]] · [[05-agents-tool-use]] · [[22-agent-orchestration]] · [[09-cost-optimization]]_
