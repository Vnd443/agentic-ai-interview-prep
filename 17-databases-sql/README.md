...
> MySQL, SQLite, schema + query design

**Tier:** 3 — Backbone  |  **Interview frequency:** Medium

## Why this matters for your interviews
The data layer. Schema design for LLM apps, indexing, and live SQL are the usual probes.

## Subtopics checklist
- [ ] Schema for LLM/RAG apps (chunks, vectors, feedback)
- [ ] Stamping prompt/model version per row
- [ ] Indexing + EXPLAIN/ANALYZE to debug slow queries
- [ ] Normalization vs. denormalization
- [ ] JOINs, GROUP BY/HAVING, window functions, CTEs
...
- Design a schema for a RAG app
- Explain indexing & debug a slow query
- Normalization vs. denormalization
