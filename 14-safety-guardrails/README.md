...
> 📌 **Seeded from AI_Engineer_Interview_Guide.pdf — Q10 (Safety).** See `interview-qa.md`.

**Tier:** 1 — GenAI Core  |  **Interview frequency:** Medium-High

## Why this matters for your interviews
Non-negotiable for production. Referencing OWASP LLM Top 10 and NIST AI RMF signals maturity.

## Subtopics checklist
- [ ] Input guardrails (injection/PII/topic filtering)
- [ ] Output guardrails (PII leak, harmful, off-topic)
- [ ] Prompt injection: direct vs. indirect (via RAG)
- [ ] Red teaming & jailbreak testing
- [ ] OWASP LLM Top 10 / NIST AI RMF
- [ ] Human-in-the-loop for high-stakes
- [ ] PII & data privacy
- [ ] Action guardrails (3rd layer): retry limits, tool-call caps, query validation, read-only enforcement
- [ ] AWS Bedrock Guardrails (managed input/output filtering) — see [[18-aws-bedrock-sagemaker]]
...
- How to make an AI system production-safe (guide Q10)
- What is prompt injection and defences
- Guardrailing an agent with tool access
