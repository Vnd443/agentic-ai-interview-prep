# 08 — MCP & Custom Agent Skills

> Model Context Protocol servers + custom agent skills (your edge)

**Tier:** 1 — GenAI Core (DIFFERENTIATOR)  |  **Interview frequency:** Medium-High & rising

## Why this matters for your interviews
Very few candidates can speak to MCP and custom skills with hands-on depth. This is the topic that makes you memorable — invest in a strong build story.

## Subtopics checklist
- [ ] What MCP is & the problem it solves (portable tools)
- [ ] MCP server surface: tools, resources, prompts
- [ ] Transports (stdio/HTTP), client-server model
- [ ] Custom skills: on-demand instructions (SKILL.md)
- [ ] Skill vs. tool vs. fine-tune vs. long prompt
- [ ] Using existing MCP servers (filesystem, GitHub, Slack, etc.)
- [ ] Building your own MCP server (expose tools / resources / prompts)
- [ ] Security of granting agents MCP tools
...
- Skills vs. tools
- Walk through an MCP server / skill you built
